...
#'
#' This data set covers 75 Pokemon evolutions spread across
#' four species. A wide set of variables are provided,
#' allowing a deeper dive into what characteristics are
#' important in predicting a Pokemon's final combat power (CP).
#'
#' @source \url{https://www.openintro.org/stat/data/?data=pokemon}, downloaded 2016-08-21
#' @format Data frame with columns
#' \describe{
#'  \item{name}{A unique name given to the Pokemon}
#'  \item{species}{The Pokemon's type, e.g. Pidgey.}
#'  \item{cp}{Pre-evolution Combat Power, which is a summary of the Pokemon's strength for battling prior to the evolution of the Pokemon.}
#'  \item{hp}{Pre-evolution Hit Points, which is a summary of how difficult it is to weaken the Pokemon in a battle.}
#'  \item{weight}{Pre-evolution weight, in kilograms.}
#'  \item{height}{Pre-evolution height, in meters.}
#'  \item{power_up_stardust}{Pre-evolution stardust required to power up the Pokemon.}
#'  \item{power_up_candy}{Pre-evolution candy required to power up the Pokemon.}
#'  \item{attack_weak}{The name of the pre-evolution weaker attack of the Pokemon.}
...
#'  \item{power_up_stardust_new}{Post-evolution stardust required to power up the Pokemon.}
#'  \item{power_up_candy_new}{Post-evolution candy required to power up the Pokemon.}
